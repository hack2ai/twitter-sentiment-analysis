  ...
  function toggleStream() {
    ...
    source.onmessage = (event) => {
      try {
        ...
        if (!item.sentiment || typeof item.confidence !== "number") {
          console.error("Invalid sentiment stream payload", item);
          return;
        }
